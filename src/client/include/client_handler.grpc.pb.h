...
#ifndef GRPC_client_5fhandler_2eproto__INCLUDED
#define GRPC_client_5fhandler_2eproto__INCLUDED
...
class ClientHandler final {
 public:
  ...
  typedef WithAsyncMethod_Ping<WithAsyncMethod_SendMusicCommand<WithAsyncMethod_GetPosition<Service > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Ping<WithCallbackMethod_SendMusicCommand<WithCallbackMethod_GetPosition<Service > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Ping<WithStreamedUnaryMethod_SendMusicCommand<WithStreamedUnaryMethod_GetPosition<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Ping<WithStreamedUnaryMethod_SendMusicCommand<WithStreamedUnaryMethod_GetPosition<Service > > > StreamedService;
};
...
#endif  // GRPC_client_5fhandler_2eproto__INCLUDED
